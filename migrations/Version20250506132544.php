 ...
 */
final class Version20250506132544 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP user_id DROP NOT NULL');
        $this->addSql('ALTER TABLE product ALTER is_bio SET NOT NULL');
    }
}
